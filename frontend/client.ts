 ...
 */
export class Client {
    public readonly accessibot: accessibot.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.accessibot = new accessibot.ServiceClient(base)
    }
...
export namespace accessibot {
    ...
    export class ServiceClient {
         ...
         */
        public async analyze(params: RequestType<typeof api_accessibot_analyze_analyze>): Promise<ResponseType<typeof api_accessibot_analyze_analyze>> {
         ...
         */
        public async batchProcessorStatus(): Promise<ResponseType<typeof api_accessibot_batch_stats_batchProcessorStatus>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/batch-processor/status`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_accessibot_batch_stats_batchProcessorStatus>
        }
         ...
         */
        public async createPullRequest(params: RequestType<typeof api_accessibot_github_createPullRequest>): Promise<ResponseType<typeof api_accessibot_github_createPullRequest>> {
            // Now make the actual call to the API
