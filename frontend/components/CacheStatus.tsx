...
import { Loader2, Database, RefreshCw, Trash2, CheckCircle, Zap, BarChart3, Timer, AlertCircle } from 'lucide-react';
  ...
  return (
    <Card className="mb-6 border-dashed">
      <CardHeader className="pb-4">
        ...
        <CardDescription>
          AI processing with intelligent caching, dynamic batch sizing, and priority queuing
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {batchStatsQuery.isError && (
          <div className="text-sm text-muted-foreground">
            Failed to load batch processor stats
          </div>
        )}
      </CardContent>
    </Card>
